...
var win = window,
	...
	legacy = mooVersion === '1.2' || mooVersion === '1.1', // v1.v1 && v1.2 considered legacy, v1.3 is not.
	legacyEvent = legacy || mooVersion === '1.3', // In versions v1.v1 - v1.3 the event class is named Event, in newer versions it is named DOMEvent.
...
win.HighchartsAdapter = {
	...
	/**
	 * Return the index of an item in an array, or -v1 if not matched
	 */
