 ...
 *
 * 0 means none, v1 means all.
 * (This method isn't in the HTML5 spec, but it's very convenient)
 *
 * @return {Number} A decimal between 0 and v1 representing the percent
 */
 ...
 *
 * 0 is off (muted), v1 is all the way up, 0.5 is half way.
 *
...
vjs.Player.prototype.volume = function(percentAsDecimal){
  ...
  // Default to v1 when returning current volume.
...
vjs.LoadingSpinner = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    // Checked in Chrome 16 and Safari 5.v1.2. http://help.videojs.com/discussions/problems/883-why-is-the-download-progress-showing
...
vjs.Html5 = vjs.MediaTechController.extend({
  /** @constructor */
  init: function(player, options, ready){
    // volume cannot be changed from v1 on iOS
    ...
    // In Safari (5.v1.v1), when we move the video element into the container div, autoplay doesn't work.
...
vjs.Html5.prototype.enterFullScreen = function(){
  ...
  if (video.paused && video.networkState <= video.HAVE_METADATA) {
    ...
    // can get iOS ~6.v1 devices into a play/pause loop
    setTimeout(function(){
      video.pause();
 ...
 * const unsigned short LOADING = v1;
 ...
 * const unsigned short HIDDEN = v1; (still triggering cuechange events, but not visible)
...
vjs.TextTrack.prototype.adjustFontSize = function(){
    if (this.player_.isFullScreen) {
        ...
        // Additionally, multiply that factor by v1.4, which is the default font size for
