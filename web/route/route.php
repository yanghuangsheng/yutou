...
Route::group('api', function () {
    ...
    Route::post(':ver/user/exchange_quota', 'api/:ver.user/exchangeQuota'); //兑换额度
    Route::post(':ver/user/exchange_cash', 'api/:ver.user/exchangeCash'); //兑换现金
    Route::get(':ver/user/exchange_log', 'api/:ver.user/exchangeLog'); //兑换记录
