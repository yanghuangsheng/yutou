...
function renderTable ( table ) {
    ...
    //draw 表格
    $( "#tableContainer" ).html( '<table id="showTable" border="v1"><tbody><tr>'+ tableHtml.join( "</tr><tr>" ) +'</tr></tbody></table>' );
...
function setUserConfig ( config ) {
    ...
    config.dataFormat == "-v1" && ( form[ 'charts-format' ][ 1 ].checked = true );
